...
class Navigate2DActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Navigate2DGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Navigate2DActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = Navigate2DGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new Navigate2DGoal()
    }
...
module.exports = Navigate2DActionGoal;
